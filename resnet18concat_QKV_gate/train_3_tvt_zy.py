...
def main(args):
    ...
    # 统一输出目录
    output_dir = os.path.join(r'D:\zxyself\output', f'{c1}_vs_{c2}', 'resnet18_QKV_gate_70143_2')
    os.makedirs(output_dir, exist_ok=True)
    ...
    for i in [6]:
        ...
        csv_path = r"D:\zxyself\output\AD_vs_MCI\optimized_dataset_split2.csv"
