...
def main():
    ...
    # === 关键设置 ===
    parser.add_argument('--num_samples', type=int, default=30, help='只测试前 N 个病人')
    ...
    test_dataset = MRIPETDataset(test_files_subset)
    test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=0)
    
    logger.info(f"Test Subset Size: {len(test_files_subset)} (Only first {args.num_samples} subjects)")
